...
function Resume() {
    ...
    return(
        <div className="resume">
            ...
            <div className="resume-line"></div>
            <div className="resume-skills">React.js, Redux, JavaScript, HTML, CSS, Ruby on Rails, SQL, PostgreSQL, Active Record, SQLite, Authentication, Object-Oriented Programming, 
                MVC Frameworks, CRUD, RESTful API, Linux ( Ubuntu ), GitHub, VSCode, Adobe Photoshop, Adobe Freehand</div>
            <br></br>
